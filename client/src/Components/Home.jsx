...
export default function HomeCarousel() {
  ...
  return (
    <>
    <div className="pt-12 relative w-full h-[400px] md:h-[680px] overflow-hidden bg-[#D1D5DB] flex items-center justify-center">
      <AnimatePresence>
          ...
          index === currentIndex ? (
            ...
            >
              <div className="w-full md:w-1/2 text-center md:text-left px-4 md:px-12">
                <p className="text-[#111827] text-sm md:text-xl font-['Poppins']">New Collection</p>
